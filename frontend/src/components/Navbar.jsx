...
export const Navbar = () => {
  ...
  return (
    <Disclosure
      as='nav'
      className='relative p-1 bg-zinc-900 dark:bg-gray-800/50 dark:after:pointer-events-none dark:after:absolute dark:after:inset-x-0 dark:after:bottom-0 dark:after:h-px dark:after:bg-white/10'
    >
